...
\begin{itemize}
\item{\textbf{Object Oriented languages: Java}, Python}
\item{Imperative languages: C}
\item{Functional languages: Scheme, Haskell}
\item{\textbf{Web languages: HTML, CSS, Javascript}}
\item{\textbf{Web technologies: JSON, Ajax, Node}}
...
\begin{minipage}[t]{0.5\textwidth}
\begin{itemize}
\item{\textbf{Algorithm design \& analysis}}
\item{\textbf{Data structures}}
\item{\textbf{Design patterns} - emphasis on MVC}
\item{Game development}
\item{Collaborative programming using \textbf{Github} \& an Agile environment}
