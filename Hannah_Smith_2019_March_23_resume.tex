...
\begin{itemize}
\item{\textit{Object Oriented languages: Java}, Python}
\item{Imperative languages: C}
\item{Functional languages: Scheme, Haskell}
\item{\textit{Web languages: HTML, CSS, Javascript}}
\item{\textit{Web technologies: JSON, Ajax, Node}}
...
\begin{minipage}[t]{0.5\textwidth}
\begin{itemize}
\item{\textit{Algorithm design \& analysis}}
\item{\textit{Data structures}}
\item{\textit{Design patterns} - emphasis on MVC}
\item{Game development}
\item{Collaborative programming using \textit{Github} \& an Agile environment}
